...
*filter
    ...
    -A FORWARD -s 10.0.0.0/8 -p udp -m multiport --dports 5243,7985,9785,11000,11202 -j ACCEPT
    ...
    -A OUTPUT -p udp -m multiport --dports 5243,7985,9785,11000,11202 -j ACCEPT
